...
foreach ($citySchedules as $entry) {
    ...
    if (!is_array($sleepDays)) {
        $sleepDays = [];
    }
    if (!is_array($breakDays)) {
        $breakDays = [];
    }
    $cleanSleepDays = [];
    ...
    $cleanCitySchedules[] = [
        ...
        'has_sleep' => $hasSleep,
        'sleep_days' => array_keys($cleanSleepDays),
        'sleep_start' => $sleepStart,
        'sleep_end' => $sleepEnd,
        'has_break' => $hasBreak,
        'break_days' => array_keys($cleanBreakDays),
